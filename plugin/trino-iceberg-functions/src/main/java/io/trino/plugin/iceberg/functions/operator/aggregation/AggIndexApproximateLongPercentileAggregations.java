...
public final class AggIndexApproximateLongPercentileAggregations
{
    private AggIndexApproximateLongPercentileAggregations() {}
    ...
    public static void output(@AggregationState AggIndexPercentileAccumulatorState state, BlockBuilder out)
    {
        ...
        if (tDigest == null) {
            ...
            BigintType.BIGINT.writeLong(out, Math.round(tDigest.valueAt(state.getPercentile())));
        }
    }
}
