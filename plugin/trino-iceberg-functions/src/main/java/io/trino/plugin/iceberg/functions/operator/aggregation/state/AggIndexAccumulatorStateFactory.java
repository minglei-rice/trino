        ...
        implements AccumulatorStateFactory<AggIndexAccumulatorState>
{
    ...
    {
        private static final long INSTANCE_SIZE = ClassLayout.parseClass(SingleAggIndexAccumulatorState.class).instanceSize();
    ...
    public static class GroupedAggIndexAccumulatorState
            ...
            implements AggIndexAccumulatorState
    {
        private static final long INSTANCE_SIZE = ClassLayout.parseClass(GroupedAggIndexAccumulatorState.class).instanceSize();
