        ...
        implements AccumulatorStateFactory<BitmapState>
{
    ...
    {
        private static final long INSTANCE_SIZE = ClassLayout.parseClass(BitmapLongAgg.class).instanceSize();
    ...
    {
        private static final long INSTANCE_SIZE = ClassLayout.parseClass(SingleBitmapState.class).instanceSize();
