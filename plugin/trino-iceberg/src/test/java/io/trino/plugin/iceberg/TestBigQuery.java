...
import static io.trino.plugin.iceberg.IcebergQueryRunner.builder;
        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        DistributedQueryRunner icebergQueryRunner =
                builder().setMetastoreDirectory(metastoreDir).setIcebergProperties(ImmutableMap.of("iceberg.query-partition-filter-required", "true")).build();
