        ...
        extends AbstractTestQueryFramework
{
    ...
    public void setUp()
    {
        ...
        // insert at least one record to ensure that predicates for non-partition keys are not treated as enforced predicates
        assertQuerySucceeds("INSERT INTO t1 VALUES (1, 'Tom', 2.5, '20220101')");
        assertQuerySucceeds("INSERT INTO t2 VALUES (1, 'Tom', 2.5)");
    }
    ...
    private QueryInfo runAndGetQueryInfo(@Language("SQL") String query)
    {
        ...
        MaterializedResultWithQueryId resultWithQueryId = queryRunner.executeWithQueryId(getSession(), query);
