...
import static io.trino.plugin.iceberg.IcebergSessionProperties.isApproxSizeInBytesEnable;
        ...
        implements ConnectorPageSourceProvider
{
            ...
            case ORC:
                ...
                return createOrcPageSource(
                        ...
                        orcReaderOptions
                                ...
                                .withApproxSizeInBytesEnable(isApproxSizeInBytesEnable(session)),
    ...
    private static ReaderPageSourceWithRowPositions createOrcPageSource(
            ...
            Optional<NameMapping> nameMapping,
            Map<Integer, Optional<String>> partitionKeys,
            Optional<OrcRowSetPredicate> orcRowSetPredicate)
    {
