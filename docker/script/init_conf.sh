...
sed --in-place "s/{EXCHANGE_MAX_CONTENT_LENGTH}/${EXCHANGE_MAX_CONTENT_LENGTH:-32MB}/" ${TRINO_ETC_DIR}/config.properties
...
sed -i "s#{CK_TAG_PASSWORD}#${CK_TAG_PASSWORD}#g" ${TRINO_ETC_DIR}/catalog/ck_tag.properties
