...
/**
 * This class is copied from io/trino/util/CompilerUtils.java.
 */
public final class CompilerUtils
{
    ...
    public static ParameterizedType makeClassName(String baseName, Optional<String> suffix)
    {
        ...
        return typeFromJavaClassName("io.trino.plugin.hive.function.$gen." + toJavaIdentifierString(className));
    }
