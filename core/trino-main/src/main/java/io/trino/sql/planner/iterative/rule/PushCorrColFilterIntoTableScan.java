...
import static io.trino.sql.planner.iterative.rule.PushJoinIntoTableScan.extractJoinCondition;
        ...
        implements Rule<JoinNode>
{
    ...
    public PushCorrColFilterIntoTableScan(PlannerContext plannerContext, TypeAnalyzer typeAnalyzer)
    {
    ...
    private Optional<CorrColFilterApplicationResult<TableHandle>> pushDown(JoinNode joinNode, Context context, TableScanAndFilter src, TableScanAndFilter target, boolean srcIsLeft)
    {
        ...
        ConnectorExpression joinCondition = extractJoinCondition(joinNode, context, plannerContext, typeAnalyzer).connectorExpression();
