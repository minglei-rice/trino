            ...
            RuleStatsRecorder ruleStats)
    {
        ...
        builder.add(
                ...
                new IterativeOptimizer(
                        ...
                        statsCalculator,
                        estimatedExchangesCostCalculator,
                        ImmutableSet.of(new EliminateCrossJoins(metadata, typeAnalyzer), new ForbidCrossJoin())), // must be run before PredicatePushDown
                new IterativeOptimizer(
                        metadata,
                        ruleStats,
                        statsCalculator,
        ...
        builder.add(
                new IterativeOptimizer(
                        ...
                        statsCalculator,
                        estimatedExchangesCostCalculator,
                        ImmutableSet.of(new PushCorrColFilterIntoTableScan(plannerContext))));
